...
export default function InteriorCTA() {
  return (
    <section className="py-20 bg-brown-deep relative overflow-hidden">
      <div className="absolute -left-24 -bottom-24 w-96 h-96 rounded-full border border-sandal/10 pointer-events-none" />
      <div className="absolute -left-12 -bottom-12 w-64 h-64 rounded-full border border-sandal/10 pointer-events-none" />
      ...
      <div className="max-w-4xl mx-auto px-5 lg:px-12 text-center relative z-10">
        ...
        <h2 className="font-playfair text-4xl lg:text-5xl font-bold text-white mb-4 leading-tight">
          ...
          <span className="block text-sandal italic">Beautiful Together</span>
        </h2>
        ...
        <p className="font-jost text-white/70 max-w-xl mx-auto leading-relaxed mb-10">
          Book a free 30-minute design discovery session — in-person or video call. We'll assess your space, understand your vision, and give you an indicative package recommendation before you commit to anything.
        </p>
        ...
        <div className="flex flex-wrap items-center justify-center gap-6 mt-10">
          {['Free Design Session', '3D Preview Included', '45-Day Delivery', '1-Year Warranty'].map((item) => (
